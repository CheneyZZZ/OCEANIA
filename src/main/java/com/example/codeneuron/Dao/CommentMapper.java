...
public interface CommentMapper {
    ...
    public Comment getCommentOfNodeByNodeId(int nodeId);

    public Comment getCommentOfEdgeByEdgeId(int edgeId);

    public Comment getCommentOfDomainByDomainId(int domainId);
