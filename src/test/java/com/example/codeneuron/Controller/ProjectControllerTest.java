...
public class ProjectControllerTest {
    ...
    public void init(){
        ...
        when(this.projectService.deleteProjectByUserId(1)).thenReturn(ResponseVO.buildSuccess(1));
        when(this.projectService.createProjectForUser(new ProjectForm("Project1",1,0))).thenReturn(ResponseVO.buildSuccess());
    ...
    @Test
    public void deleteProjectForUser() throws Exception{
        MockMvc mockMvc=standaloneSetup(projectController).build();
        mockMvc.perform(delete("/project/deleteAll")
        .param("userId","1"))
                .andExpect(status().isOk());
    }
    @Test
